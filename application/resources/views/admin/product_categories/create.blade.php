...
@section('content')
    <div class="col-12 mt-4">
        <form class="form-signin" method="POST" action="{{ route('admin.product_categories.store') }}">
            @csrf
            ...
            <div class="row">
                <div class="col-2 mt-4">
                    <a class="btn btn-lg btn-dark" href="{{ route('admin.product_categories.index') }}">キャンセル</a>
                </div>
                <div class="col-2 mt-4">
