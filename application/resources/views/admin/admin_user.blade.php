...
@section('content')
    <div class="col-12 mt-4">
        <form class="form-signin" method="GET" action="{{ route('admin.admin_users') }}">
            @csrf
            <div class="border row center-block text-center">
                ...
                <div class="col-5 mt-4">
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="authorityRadio1" name="iauthorityRadioOptions" value="999" @if ($old['iauthority'] == 999) checked @endif>
                    ...
                    <div class="form-check form-check-inline">
                        <input type="radio" class="form-check-input" id="authorityRadio3" name="iauthorityRadioOptions"  value="0" @if ($old['iauthority'] == 0) checked @endif>
                ...
                <div class="col-4 mt-4">
                    <select class="form-control" name="sortType">
                        ...
                        <option value="email"  @if ($old['sortType'] == "email") selected="selected" @endif>並び替え: メールアドレス</option>
                    </select>
                </div>
                <div class="col-4 mt-4">
    ...
    <div class="mt-3 mb-3">
        <button class="btn btn-success" onclick="location.href='{{ route('admin.admin_users_create') }}'">新規</button>
    </div>
